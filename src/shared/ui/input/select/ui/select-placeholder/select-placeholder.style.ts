...
export const selectPlaceholderVariants = cva(
  'bg-primary padding-x-16 padding-y-12 border-radius-lg placeholder:placeholder-text-primary flex cursor-pointer items-center justify-between select-none',
  {
    variants: {
      variant: {
