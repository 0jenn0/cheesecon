...
export default function GlobalNavigationBar() {
  return (
    <header className='border-ghost padding-y-12 sticky top-0 right-0 left-0 z-10 flex w-full items-center justify-center border-b bg-white/60 backdrop-blur-lg'>
