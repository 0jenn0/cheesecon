  ...
  return (
    <div
      ...
      className={cn(
        ...
        'padding-24 rounded-2xl border-2 border-dashed transition-all duration-300 ease-in-out',
        isDragActive
    ...
    >
      ...
      {imageUrl && !isLoading && (
        <div className='flex h-full w-full items-center justify-center'>
          <div className='group/image bor border-radius-xl bg-primary border-ghost effect-shadow-4 relative aspect-square w-full overflow-hidden border-1'>
            <Image
              width={300}
              height={300}
              src={imageUrl}
