...
interface EmoticonFormDesktopScreenProps {
  action: 'create' | 'update';
}

export default function EmoticonFormDesktopScreen({
  action,
}: EmoticonFormDesktopScreenProps) {
  ...
  return (
    <>
      ...
      <RegisterBottomBar action={action} />
    </>
  );
}
